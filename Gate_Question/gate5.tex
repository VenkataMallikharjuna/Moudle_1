...
\textbf{The canonical sum of product representations of $\textbf{F}$ is} 
 \begin{enumerate}[label=(\Alph*)]
        \item  $F\brak{X,Y,Z,W} = \Sigma \hspace{3pt}m \brak{0,1,3,14,15}$
        \item  $F\brak{X,Y,Z,W} = \Sigma \hspace{3pt}m \brak{0,1,3,11,14}$
        \item  $F\brak{X,Y,Z,W} = \Sigma \hspace{3pt}m \brak{2,5,9,11,14}$
        \item  $F\brak{X,Y,Z,W} = \Sigma \hspace{3pt}m \brak{1,3,7,9,15}$
    \end{enumerate}
\end {enumerate}
\end{document}
